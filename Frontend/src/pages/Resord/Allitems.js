    ...
    return (
        <Wrap>
            ...
            <Cart>
                ...
                <label style={{fontSize:"20px"}}>Items addded to the cart are:-</label>
                <Cartitems>
                    <ul>
                        <Product>
                ...
                <li style={{fontSize:"22px"},{padding:"10px"}}>You are one step behind, click on the order button and get the meal.</li>
                <button>Order</button>
            </Cart>
        </Wrap>
    )
